...
//                                         ],
//                                       ).onTap(() {
//                                         _shareAddress(user.address);
//                                         Constants.showAd && resultShare? Constants.showIntertitialAd(): SizedBox();
//                                       }),
//                                     ],
//                                   ),
//                                   16.heightBox,
...
//   Future<void> _shareAddress(String? userAddress) async {
...
//                       dense: true,
//                       title: const Text(
//                         "you are currently Resident here",
//                         style: AppTheme.smallText,
//                       ),
//                       value: checkedValue,
...
//                     child: QrImageView(
//                       data:
//                           "Owner Name: ${Constants.userData.firstName} ${Constants.userData.lastName}\nLocation: ${Constants.userData.address}\nGuest Name: ${data['name']}\nRole: ${data['role']}",
...
//       eyeStyle:
//           const QrEyeStyle(eyeShape: QrEyeShape.square, color: Colors.red),
...
//                             type == "Vehicle" ? DropdownButtonFormField2<String>(
//                               isExpanded: true,
//                               decoration: InputDecoration(
//                                 disabledBorder: OutlineInputBorder(
//                                   borderRadius: BorderRadius.circular(16),
...
//                                   // AlbumScreen(
//                                   //   albumId: albumId,
//                                   //   householdName: householdName.text,
//                                   // ),
//                                   // );
